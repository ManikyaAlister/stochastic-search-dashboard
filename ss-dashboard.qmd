...
load(here("output/simdata-norm-100-simulations-100-iterations-20-chains-10-grid-size.Rdata"))
```
...
# generaste landscape that should have the most extreme (max/min) variance in rewards
extreme_landscape <- generataeLandscape(grid_size, min_spatial_cor, max_variance)
landscape_rewards <- extreme_landscape$rewards
max_reward <- max(landscape_rewards)
min_reward <- 0
